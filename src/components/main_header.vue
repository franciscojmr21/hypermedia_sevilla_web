...
<!-- Principal Title -->
    <header id="header" class="jquery-ripples">
      <div class="container">
        <div class="row height-90 align-items-center justify-content-center">
          <div class="col">
            <div class="banner text-center">
              <h1 class="display-1 text-capitalize underline w-5000 mx-auto">
                <strong class="title_sevilla">{{this.title}} </strong> <small class="primary-color"><br>{{this.title2}}</small>
              </h1>
            </div>
          </div>
        </div>
...
#header {
  ...
  background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../assets/background.jpg)center/cover fixed no-repeat;
  position: relative;
}
