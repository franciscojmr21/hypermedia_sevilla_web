    ...
    <nav class="navbar navbar-expand-lg">
      ...
      <div class="navbar-collapse collapse" id="myNav" style="">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item">
            <a class="nav-link text-capitalize" href="About_us.html">ABOUT US</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-capitalize" href="#points_of_interest">POINTS OF INTEREST</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-capitalize" href="#events">EVENTS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-capitalize" href="#itineraries">ITINERARIES
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-capitalize" href="#service_types">SERVICE TYPES
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-capitalize" href="#contact_us">CONTACT US</a>
          </li>
        </ul>
        <div class="nav-icons d-none d-lg-block">
          <a href="https://es-la.facebook.com/AyuntamientodeSevilla" target="_blank" rel="noopener noreferrer" class="nav-icon">
          ...
          <a href="https://twitter.com/sevillaciudad" target="_blank" rel="noopener noreferrer" class="nav-icon">
          ...
          <a href="https://www.instagram.com/ayto_sevilla/" target="_blank" rel="noopener noreferrer" class="nav-icon">
